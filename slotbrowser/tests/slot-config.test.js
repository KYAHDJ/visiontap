...
test('new accounts use exactly 1 second and 4.5 seconds', () => {
  for(const [user,id,ms] of [['axceling1001','15',1000],['nnnikkikim','16',4500]]) assert.equal(Slot.prototype.getSubmitDelayMs.call({id,_creds:{user}}),ms);
});
